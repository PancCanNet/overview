...
# apply visual style 
RCy3::copyVisualStyle("default","WikiPathways")
...
RCy3::setNodeShapeMapping('Type', c('GeneProduct','Pathway','Drug'), c("ellipse","rectangle","hexagon"), style.name="wp.vis")
RCy3::setNodeSizeMapping('Type', c('GeneProduct','Pathway'), c(40,25), mapping.type = "d", style.name = "wp.vis")
#RCy3::setNodeCustomHeatMapChart(c("B_logFC","C_logFC"), slot = 2, style.name = "wp.vis")

setNodeCustomHeatMapChart(c("B_logFC","C_logFC"), slot = 2, style.name = "wp.vis")

#data.values = c(-1,0,1) 
#node.colors <- c(rev(brewer.pal(length(data.values), "RdBu")))
#setNodeColorMapping(c("B_logFC"), data.values, node.colors, default.color = "#99FF99", style.name = "wp.vis")
...
log.nodes <- selectNodes(!NA, by.col = "B_logFC", preserve = FALSE)$nodes 
clearSelection()
setNodeCustomHeatMapChart(c("B_logFC","C_logFC"), slot = 2, style.name = "wp.vis")
